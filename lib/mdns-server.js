...
function Server(opts) {
	...
	this.mdns.on('error', this._mdnsError.bind(this));
}
...
Server.prototype._mdnsError = function (err) {
	console.error('Received multicast DNS error in the inner levels of source: ', err);
};
